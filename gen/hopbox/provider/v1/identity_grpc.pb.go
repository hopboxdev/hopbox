...
const (
	Identity_Authenticate_FullMethodName = "/hopbox.provider.v1.Identity/Authenticate"
	Identity_Authorize_FullMethodName    = "/hopbox.provider.v1.Identity/Authorize"
)
...
// their SSO/customer model onto Hopbox tenants without forking the core.
...
var Identity_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hopbox.provider.v1.Identity",
	...
	Metadata: "hopbox/provider/v1/identity.proto",
}
